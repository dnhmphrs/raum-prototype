export const RiemannShader = `
    ...
    fn vertexMain(@location(0) position: vec3<f32>) -> VertexOutput {
        ...
        // Complex domain coloring based on x,y coordinates (real and imaginary parts)
        let colorTime = timeUniform.time * 0.1;
        output.color = domainColoring(position.x, position.y, colorTime);
