            ...
            <div class="theta">
              ...
              <div class="tau">
                <p>
                    ...
                    This will allow us the model how how the grid code captures the subtle complexities of real-life phenomena. As a start, we can model the grid code with shallow water waves (there are <i>big</i> complexities; see [Sato, 1981]), but the real maths will take a year or so to figure out and I will need Türkü.
                ...
                <div class="psychosis">
                    <p>
                        ...
                        In pyschosis, we may expect that the regular hexagonal grids dissapear somewhat (impaired fronto-tempporal connectivity [Friston and Frith, 1995] due to a 'noisy' projection from mPFC to the MEC grid code [conjecture]). The MEC grid code will instead look chaotic: <i>a raging sea.</i>
                    </p>
              </div>
        </div>
        {/if}
