              ...
              <div class="tau">
                ...
                <div class="psychosis">
                    <p>
                        ...
                        In pyschosis, we may expect the regular hexagonal to grids diminish (impaired fronto-tempporal connectivity [Friston and Frith, 1995] due to a 'noisy' projection from mPFC to the MEC grid code [conjecture]). The MEC grid code will instead look chaotic: <i>a raging sea.</i>
                    </p>
              </div>
        </div>
        {/if}
